...
@section('content')
	...
	<form method="POST" action="{{route('register')}}" class="w-full px-3 mx-4 sm:mx-0 sm:w-1/2 md:w-1/2 lg:w-1/4 h-auto flex flex-col gap-y-3 justify-center items-center">
		@csrf
